...
parser.add_argument('--loss','-lo', type=str, default='JeffLoss', required=False, help='loss function to use, there is MSE, NMSELoss, NMSERL1Loss')
...
class ResNet(nn.Module):
    def __init__(self, ResidualBlock, out_dim=out_dim):
        ...
        self.fc = nn.Linear(35328, out_dim)
...
def ResNet18():
    return ResNet(ResidualBlock,out_dim=out_dim)
...
torch.save(model, f'figures/{args.output_dir}/model.pth')